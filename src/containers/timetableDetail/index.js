...
} from "./actions/TimeTableDetailActions";
...
class TimeTableDetails extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (!item && isLoading) {
      this.props.getTimetableDetail(match.params.dayId);
...
export default connect(
  state => ({
    item: state.TimeTableDetailReducer.item,
    isLoading: state.TimeTableDetailReducer.isFetching,
    error: state.TimeTableDetailReducer.error
  }),
  mapDispatchToProps
)(withStyles(styles)(TimeTableDetails));
